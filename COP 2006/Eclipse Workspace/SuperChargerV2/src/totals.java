...
public class totals {
	...
	// Fields initialized here
		...
		private double stallTotal;
		private double stallTime;
		private double total;
		private double time;
		private double totalComplimentary;
		private double timeComplimentary;
		
		private static ArrayList<Double> stallTotalList;
		private static ArrayList<Double> stallTimeList;
		private static ArrayList<Double> totalList;
		private static ArrayList<Double> timeList;
		private static ArrayList<Double> totalComplimentaryList;
		private static ArrayList<Double> timeComplimentaryList;
